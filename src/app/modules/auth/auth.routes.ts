...
// Register user - now accepts image URL directly in the request body
router.post("/register", validateRequest(registerValidationSchema), authControllers.register);
