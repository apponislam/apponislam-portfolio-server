...
exports.renderAdminReplyEmailHtml = exports.renderAutoReplyEmailHtml = exports.renderContactEmailHtml = void 0;
/**
 * 1. Contact Form Submission Admin Notification Email HTML Template
 */
const renderContactEmailHtml = ({ name, email, message, social, replyUrl }) => {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
...
exports.renderContactEmailHtml = renderContactEmailHtml;
/**
 * 2. Contact Auto Reply Confirmation Email HTML Template
 */
const renderAutoReplyEmailHtml = ({ name }) => {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
...
exports.renderAutoReplyEmailHtml = renderAutoReplyEmailHtml;
/**
 * 3. Admin Custom Reply Email HTML Template
 */
const renderAdminReplyEmailHtml = ({ recipientName, replyMessage, originalMessage }) => {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
...
exports.renderAdminReplyEmailHtml = renderAdminReplyEmailHtml;
